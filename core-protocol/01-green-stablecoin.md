...
포지션이 [담보 상환 구간](04-liquidations.md#담보-상환-버퍼)에 들어가면 GREEN 보유자는 누구나 해당 포지션을 상대로 담보 상환을 실행할 수 있습니다. GREEN을 $1로 지불하고 오라클 가격의 담보를 받습니다. 할인도 페널티도 없으며, 차용자의 부채는 같은 금액만큼 줄어듭니다. 수량은 내림 처리됩니다.
