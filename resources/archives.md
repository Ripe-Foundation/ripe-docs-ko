...
- [Endaoment](https://www.ripe.finance/whitepaper#endaoment) – 안정성과 수익을 위한 자금을 지원하는 Ripe의 자율적인 트레저리
- [본드 메커니즘](https://www.ripe.finance/whitepaper#bonding) – 본드가 GREEN의 안정성과 자본 효율성을 지원하는 방법
...
> **역사적 배경**: 이 백서는 그 시점의 당시 생각을 반영한 것입니다. 출시된 프로토콜에는 Juice Score(복잡성을 줄이기 위해 제거됨) 및 GREEN 본드(위험을 줄이기 위해 제거됨)가 포함되어 있지 않습니다.
...
- [Endaoment](https://medium.com/ripe-finance/the-ripe-endaoment-479ad51e836b) – 지속 가능한 성장을 보장하는 프로토콜 소유 트레저리
- [본드 메커니즘](https://medium.com/ripe-finance/the-ripe-bonding-mechanism-4f859bdef774) – 본드가 효율성을 높이고 담보의 생산성을 향상시키는 방법
