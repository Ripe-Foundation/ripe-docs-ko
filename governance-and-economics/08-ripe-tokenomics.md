...
프로토콜 사용 및 성장을 직접적으로 장려하는 블록 보상, 본드 할인 및 LP(유동성 공급자) 보상. TGE에서 분배가 시작되는 유일한 할당입니다.
...
![RIPE 발행 일정](https://miro.medium.com/v2/format:webp/1*_cx_OWu-kZAygnVZeLI5Cw.png)
