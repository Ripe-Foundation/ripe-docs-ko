...
**5단계.** 보상은 자동으로 누적되어 대시보드에 표시됩니다. RIPE로 지급되기 때문에 청구하면 [다음 가이드에서 설명하는 청구 창](06-get-and-lock-ripe.md#undefined)이 열리고, 청구량 일부가 스테이킹되고 잠깁니다. 처음 청구하기 전에 해당 섹션을 읽으세요.
